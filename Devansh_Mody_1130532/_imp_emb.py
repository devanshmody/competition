...
class Sentimentmodel(object):
    def __init__(self, args):
        ...
        if args.bidirect:
            self.model = BiLSTMModel(args.model, self.ntokens, args.emb_size, args.hidden_size, args.vocab.i2w, args.nlayers, args.dropout,
                                     args.bidirect, nlabels=self.nlabels).to(self.device)
        else:
            self.model = UniLSTMModel(args.model, self.ntokens, args.emb_size, args.hidden_size, args.vocab.i2w, args.nlayers, args.dropout,
                                      args.bidirect, nlabels=self.nlabels).to(self.device)
    ...
    def train(self):
        ...
        try:
            ...
            for epoch in range(1, self.args.epochs + 1):
                ...
                if not best_val_loss or val_metrics["f1"] < best_val_loss:
                    nimp = 0
                    best_epoch = epoch
...
if __name__ == '__main__':
    ...
    prefix = "emb_metric_senti_cls_uni"
    if args.bidirect:
        prefix = "emb_metric_senti_cls_bi"
